<template>
    <div>
        ...
        <div class="pt-24">
            ...
            <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                ...
                <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                    <h1 class="my-4 text-5xl font-bold leading-tight">Write Daily Tasks And Never Forget Them</h1>
                </div>
                <!--Right Col-->
            ...
            <div class="container max-w-5xl mx-auto m-8">
                ...
                <div class="flex flex-wrap">
                    <div class="w-5/6 sm:w-1/2 p-6">
                        <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">VueTodo</h3>
                        <p class="text-gray-600 mb-8">Is Open Source Todo-list Please Send Your Idea About This
                            Project<br/><br/>
                            GitHub: <a class="text-green-500 underline" href="https://github.com/alifatahi/VueTodo">alifatahi/VueTodo</a>
                        </p>

                    </div>
                    <div class="w-5/6 sm:w-1/2 p-6">
                        <img src="../../assets/img/app.jpg" alt="App">
                    </div>
        ...
        <section class="container mx-auto text-center py-6 mb-12">
            ...
            <h3 class="my-4 text-3xl leading-tight">Ask Any Question</h3>
            <form class="w-full text-center" action="#" @submit.prevent="contact">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                               id="grid-last-name" type="text" placeholder="Doe" v-model="email">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-2">
                    <div class="w-full md:w-1/1 px-3 mb-6 md:mb-0">
                        ...
                        <textarea name=""
                                  ...
                                  id="" cols="5" rows="2" v-model="message"></textarea>
                    </div>
                </div>
            ...
            contact() {
                ...
                this.$store.dispatch('contact', {
                    ...
                    this.$toast.success({
                        ...
                        message: 'Your Message Send Thank You.',
                    })
